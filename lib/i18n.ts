...
export const dictionary = {
  ...
  ar: {
    ...
    seo: {
      ...
      honkaiStarRailDescription: "تتيح أكواد الاستبدال في هونكاي: ستار ريل للاعبين الحصول على مكافآت مجانية مثل اليشم النجمي، والائتمانات، ودليل المسافر، ومواد ترقية مخروط الضوء.",
